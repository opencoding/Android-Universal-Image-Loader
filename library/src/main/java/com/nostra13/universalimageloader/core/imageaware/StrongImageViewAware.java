 ...
 * @since 1.9.0
 */
public class StrongImageViewAware extends StrongViewAware {

    /**
     * Constructor. <br />
     * References {@link #StrongImageViewAware(ImageView, boolean) ImageViewAware(imageView, true)}.
     *
     * @param imageView {@link ImageView ImageView} to work with
     */
    public StrongImageViewAware(ImageView imageView) {
        super(imageView);
    }
     ...
     *                            <p/>
     */
    public StrongImageViewAware(ImageView imageView, boolean checkActualViewSize) {
    ...
    public int getWidth() {
        ...
        if (width <= 0) {
            ImageView imageView = (ImageView) viewRef;
            if (imageView != null) {
