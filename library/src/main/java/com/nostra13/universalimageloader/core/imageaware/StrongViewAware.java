 ...
 * @since 1.9.2
 */
public abstract class StrongViewAware implements ImageAware {
    ...
    /**
     * Constructor. <br />
     * References {@link #StrongViewAware(android.view.View, boolean) ImageViewAware(imageView, true)}.
     *
     * @param view {@link android.view.View View} to work with
     */
    public StrongViewAware(View view) {
        this(view, true);
    }
     ...
     *                            save memory.
     */
    public StrongViewAware(View view, boolean checkActualViewSize) {
